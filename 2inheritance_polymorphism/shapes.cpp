...
#include <vector>
using namespace std;
//Abstract class = 1 or more pure virtual methods
class Shape{//Can't have an object whose type is JUST Shape
private:
	std::size_t sides_;
public:
	Shape(){}
	...
	//we may wish to also have a pure virtual area method
};
